...
export default function ProductCard({ item, categoryLabel, onDeleted }) {
  ...
  return (
    <article
      ...
      className={"grid gap-6 rounded-[28px] border p-6 shadow-lg hover:shadow-2xl transition-shadow duration-300 cursor-pointer md:grid-cols-[220px_minmax(0,1fr)] " + card}
    >
      <div className={"overflow-hidden rounded-3xl " + imgPanel}>
        <img
          src={item.image}

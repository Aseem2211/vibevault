...
export default function Stationary() {
  ...
  useEffect(() => {
    getItemsBySection("stationary")
      .then((res) => setItems(res.data.articles??[]))
      .catch((err) => console.error("Failed to load stationary:", err))
